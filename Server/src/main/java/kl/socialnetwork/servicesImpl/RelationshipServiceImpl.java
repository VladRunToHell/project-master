...
import kl.socialnetwork.domain.models.viewModels.relationship.*;
...
public class RelationshipServiceImpl implements RelationshipService {
    ...
    public boolean createRequestForAddingFriend(String loggedInUserId, String friendCandidateId) throws Exception {
        ...
        if (relationshipFromDb == null) {
            ...
            relationship.setTime(LocalDateTime.now().toInstant(ZoneOffset.MAX));
            ...
            relationshipFromDb.setTime(LocalDateTime.now().toInstant(ZoneOffset.MAX));
